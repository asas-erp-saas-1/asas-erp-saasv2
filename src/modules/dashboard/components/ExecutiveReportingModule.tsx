    ...
    <div className="w-full h-full flex flex-col space-y-6 animate-in fade-in duration-700 bg-transparent text-white pt-0 md:pt-4 px-4 md:px-0">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 py-2 mt-4 md:mt-0">
        <div>
          ...
          <p className="text-white/50 text-[10px] sm:text-[11px] uppercase tracking-widest font-bold mt-2">Génération automatisée des rapports stratégiques et synthèses pour le comité de direction</p>
        </div>
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto mt-2 md:mt-0">
          ...
          <button className="flex items-center justify-center gap-2 px-5 py-3 md:py-2 bg-asas-gold hover:bg-[#E0B96B] text-[#051121] rounded-xl text-xs font-bold uppercase tracking-widest transition-colors shadow-[0_0_15px_rgba(212,166,79,0.3)] hover:shadow-[0_0_20px_rgba(212,166,79,0.5)]">
