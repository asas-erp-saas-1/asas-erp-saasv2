...
export function CEODashboard({ initialMetrics }: { initialMetrics?: any }) {
  ...
  return (
    <div className="mt-8 pb-12 overflow-hidden">
      ...
      >
        {/* Card 1 */}
        <motion.div variants={item} className="bg-gray-50 dark:bg-[#050505] p-6 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-2xl hover:border-black/10 dark:border-white/10 hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-1 font-display">{((kpis.pipelineWeightedValue || 0) / 1000000).toFixed(1)}M <span className="text-lg text-gray-600 font-medium">DZD</span></h3>
        ...
        <motion.div variants={item} className="bg-gray-50 dark:bg-[#050505] p-6 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-2xl hover:border-black/10 dark:border-white/10 hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-1 font-display">{((kpis.revenueAccrualMTD || 0) / 1000000).toFixed(1)}M <span className="text-lg text-gray-600 font-medium">DZD</span></h3>
        ...
        <motion.div variants={item} className="bg-gray-50 dark:bg-[#050505] p-6 rounded-[2rem] border border-black/5 dark:border-white/5 shadow-2xl hover:border-black/10 dark:border-white/10 hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-1 font-display">{kpis.conversionRate || 0}<span className="text-lg text-gray-600 font-medium">%</span></h3>
        ...
        <motion.div variants={item} className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-[2rem] border border-gray-800 shadow-[0_4px_20px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.2)] hover:-translate-y-1 transition-all duration-300 group overflow-hidden relative">
          ...
          <div className="relative z-10">
            <div className="flex items-start justify-between mb-8">
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-black/10 dark:bg-white/10 text-gray-900 dark:text-white border border-black/10 dark:border-white/10 backdrop-blur-md group-hover:scale-110 group-hover:-rotate-3 transition-transform">
                <Wallet className="w-6 h-6" strokeWidth={1.5} />
              </div>
            </div>
            <p className="text-xs font-bold text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wider">Trésorerie Actuelle</p>
            <h3 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-1 font-display">{((kpis.cashBalance || 0) / 1000000).toFixed(1)}M <span className="text-lg text-gray-500 font-medium">DZD</span></h3>
      ...
      >
        {/* Activity Feed */}
        <div className="md:col-span-2 bg-gray-50 dark:bg-[#050505] border border-black/5 dark:border-white/5 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <div className="flex flex-col gap-3 relative z-10">
            {[1, 2, 3].map((_, i) => (
              <div key={i} className="group flex items-center justify-between p-4 bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/5 hover:border-black/10 dark:border-white/10 rounded-2xl transition-all cursor-pointer">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 dark:text-white">{i === 1 ? 'Transaction conclue: Villa Atlas' : 'Nouveaux leads ajoutés via portail'}</p>
        ...
        <div className="bg-gray-50 dark:bg-[#050505] rounded-[2rem] p-8 text-gray-900 dark:text-white shadow-2xl relative overflow-hidden flex flex-col border border-black/5 dark:border-white/5 group">
          ...
          <div className="relative z-10 flex-1 flex flex-col">
            <h3 className="text-2xl font-extrabold mb-3 tracking-tight font-display text-gray-900 dark:text-white">Hub de Commandement</h3>
            <p className="text-gray-500 text-sm font-medium leading-relaxed mb-8">
              Raccourcis vers vos workflows les plus critiques. Ne perdez pas une seconde.
            </p>
            
            <div className="space-y-3 mt-auto">
              <Link href="/dashboard/deals" className="w-full flex items-center justify-between px-5 py-4 bg-white dark:bg-[#0A0A0A] hover:bg-gray-200 dark:bg-[#171717] border border-black/5 dark:border-white/5 backdrop-blur-md rounded-2xl transition-all text-sm font-bold text-gray-900 dark:text-white group/link">
              ...
              <Link href="/dashboard/metrics" className="w-full flex items-center justify-between px-5 py-4 bg-white dark:bg-[#0A0A0A] hover:bg-gray-200 dark:bg-[#171717] border border-black/5 dark:border-white/5 backdrop-blur-md rounded-2xl transition-all text-sm font-bold text-gray-900 dark:text-white group/link">
