...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[100dvh] w-full items-center justify-center bg-gray-50 dark:bg-[#050505] text-gray-900 dark:text-white px-4 py-12">
      <div className="w-full max-w-md p-6 sm:p-8 border border-gray-200 dark:border-[#262626] bg-white dark:bg-[#0A0A0A] rounded-3xl shadow-2xl my-auto">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-center text-sm mb-8">Sign in to your account</p>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-200 dark:bg-[#171717] border border-gray-200 dark:border-[#262626] rounded-xl px-4 py-2 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-gray-900 dark:text-white font-bold py-2.5 rounded-xl transition-colors mt-4 disabled:opacity-50"
          >
