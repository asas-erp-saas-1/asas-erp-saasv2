  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] p-8 text-center bg-asas-sand dark:bg-[#141618] text-asas-charcoal dark:text-asas-sand">
      ...
      <div className="flex gap-4">
        ...
        <Link href="/login" className="flex items-center gap-2 px-6 py-3 bg-transparent text-asas-charcoal dark:text-asas-sand border border-asas-silver/20 rounded-sm font-bold uppercase tracking-widest text-[10px] hover:bg-white/10 transition-colors">
