...
export default function GlobalError({
  ...
  return (
    <html lang="fr">
      <body className="bg-gray-50 dark:bg-[#050505] text-gray-900 dark:text-gray-100 flex items-center justify-center min-h-screen p-4">
        <div className="max-w-md w-full bg-[#111] border border-red-500/20 rounded-3xl p-8 text-center shadow-2xl backdrop-blur-xl">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900 dark:text-white mb-2 tracking-tight">System Critical Failure</h1>
