      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-[#050505]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 text-sm font-bold">
            <Link href="#features" className="text-gray-400 hover:text-white transition-colors">Fonctionnalités</Link>
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-6 pt-20 pb-32 text-center flex flex-col items-center">
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-gray-400 font-medium max-w-2xl mb-12"
          >
          ...
          >
            ...
            <Link href="#features" className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-full transition-all text-sm font-extrabold flex items-center justify-center gap-2">
        ...
        <section id="features" className="max-w-7xl mx-auto px-6 py-24 border-t border-white/5 relative">
           <div className="text-center mb-16">
              ...
              <p className="text-gray-400 font-medium max-w-xl mx-auto">Chaque module est conçu pour fonctionner en parfaite synchronicité avec le reste du système.</p>
           </div>
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="bg-[#0A0A0A] border border-white/5 p-8 rounded-[2rem] hover:border-white/10 transition-all hover:-translate-y-1 group">
